...
#Reading the video
vidcap = cv2.VideoCapture(r'C:\Users\iTparK\Desktop\New folder\Player-detection-and-ball-detection-main\football_match_video.mp4')
...
while success:
	...
	count += 1
	cv2.imshow('Football Player Detection',image)
